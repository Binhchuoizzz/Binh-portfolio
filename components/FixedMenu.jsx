...
const FixedMenu = () => {
     ...
     // prevent redering until mounted
               ...
               <AnimatePresence>
                    {showMenu && showMenuButton && (
                         <motion.div
                              ...
                              className="relative w-full max-w-md md:max-w-none h-[400px]
                         bottom-[30rem] xl:bottom-[22rem] px-4 pointer-events-auto"
                         >
                                   ...
                                   <div className="hidden md:flex mx-auto">
                                        <div>
                                             ...
                                             <Socials
                                                  ...
                                                  iconStyles="text-[20px] w-[32px] h-[32px] text-primary flex
               ...
               {isMobile ? (
                    <div className="fixed z-50 bottom-16">
                         <button
                              ...
                              className="bg-accent/80 shadow-custom w-[54px] h-[54px] rounded-lg cursor-pointer flex items-center justify-center select-none pointer-events-auto"
                         >
                    ...
                    <AnimatePresence>
                         {showMenuButton && (
                              ...
                              >
                                   <button
                                        onClick={() => setShowMenu(!showMenu)}
                                        className="bg-accent/80 shadow-custom w-[54px] h-[54px] rounded-lg cursor-pointer flex items-center justify-center select-none"
                                   >
                                        <CgMenuGridR className="text-4xl text-white" />
                                   </button>
                              </motion.div>
